...
DEMO_SAMPLES = [
    {
        ...
        "description": "Actual human speech recording with natural acoustic properties.",
        "expected": "real",
    },
    {
        "id": "fake_voice",
        "filename": "fake_voice.wav",
        "label": "AI Cloned Voice (Kidnapping Scam)",
        "description": "AI-generated voice simulating a kidnapping emergency call.",
        "expected": "fake",
    },
    {
        "id": "fake_voice_2",
        "filename": "fake_voice_2.wav",
        "label": "AI Cloned Voice (Bank Fraud)",
        "description": "AI-generated voice impersonating a bank security officer.",
        "expected": "fake",
    },
]
